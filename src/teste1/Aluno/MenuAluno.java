...
public class MenuAluno extends javax.swing.JFrame {
    ...
    public MenuAluno() {
        ...
        try {
            fundo = ImageIO.read(new File("/home/solar/NetBeansProjects/Biblioteca/Teste1/src/teste1/PERFIL_ALUNO_PAGINA_PRINCIPAL[1].png"));
            barra = ImageIO.read(new File("/home/solar/NetBeansProjects/Biblioteca/Teste1/src/teste1/BARRA PINCEL.png"));
        } 
        catch (IOException e) {
        ...
        jLabel12.setSize(this.getLarguraTela(), (this.getAlturaTela()));
        Image dimg2 = barra.getScaledInstance(jLabel12.getWidth(), jLabel12.getHeight(), Image.SCALE_SMOOTH);
