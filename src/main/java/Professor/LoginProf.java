...
public class LoginProf extends javax.swing.JFrame {
    ...
    public LoginProf() throws Exception {
        initComponents();
    ...
    private void Tela(){
        ...
        try {
            fundo = ImageIO.read(new File("C:\\SQL2022\\NetBeansProjects\\Teste1\\src\\teste1\\biblioteca.png"));
        } 
        catch (IOException e) {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(822, 889));
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(1088, 692));
        ...
        Titulo.setText("Login Professor");
